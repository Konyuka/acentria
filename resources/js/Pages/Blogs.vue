...
<template>
    <AppLayout>
        <div class="bg-white px-6 py-10 sm:py-10 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                <h2
                    class="text-4xl font-bold tracking-tight text-primary sm:text-6xl"
                >
                    News, Blogs & Updates
                </h2>
            </div>
                        ...
                        <div class="max-w-xl">
                            ...
                            <div class="group relative">
                                ...
                                >
                                    ...
                                    eligendi. Hic vel totam vitae illo. Non
                                    aliquid explicabo necessitatibus unde. Sed
