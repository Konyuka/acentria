        ...
        <div class="relative isolate bg-white">
            <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                ...
                >
                    <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                        ...
                        <dl
                            class="mt-10 space-y-4 text-base leading-7 text-gray-600"
                        >
                ...
                >
                    <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                        ...
                        <div class="mt-8 flex justify-end">
                            <button
                                type="submit"
                                class="rounded-md bg-primary px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-secondary hover:scale-90 duration-700 ease-in-out focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                            >
                                Send message
                            </button>
                        </div>
            ...
            <div class="relative w-full h-[70vh]">
                <iframe
                    ...
                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7977.693480237462!2d36.807116!3d-1.2644720000000003!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f176afe68fe1b%3A0xf590c6d95ac4594f!2sWestpark%20Towers!5e0!3m2!1sen!2ske!4v1704699711829!5m2!1sen!2ske"
                    frameborder="0"
                    style="border: 0"
                    allowfullscreen=""
                    aria-hidden="false"
